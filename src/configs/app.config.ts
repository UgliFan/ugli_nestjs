...
export const CROSS_DOMAIN = {
  allowedOrigins: ['https://ugli.fans', 'https://cdn.ugli.fans', 'https://admin.ugli.fans'],
  allowedReferer: 'ugli.fans',
};
...
export const AKISMET = {
  ...
  blog: argv.akismet_blog || 'your Akismet blog site, e.g. https://ugli.fans',
};

// https://ziyuan.baidu.com/linksubmit/index
export const BAIDU_INDEXED = {
  site: argv.baidu_site || 'your baidu site domain. e.g. ugli.fans',
...
export const BING_INDEXED = {
  site: argv.bing_site || 'your bing site url. e.g. https://ugli.fans',
